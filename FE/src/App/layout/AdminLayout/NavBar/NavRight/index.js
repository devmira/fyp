    ...
    <Aux>
      <ul className="navbar-nav ml-auto">
        ...
        <li className={props.rtlLayout ? 'm-r-15' : 'm-l-15'}>
          <a href={DEMO.BLANK_LINK} className="displayChatbox" onClick={() => {setList(true)}}><i className="icon feather icon-mail"/></a>
        </li>
        <li>
          <Dropdown alignRight={!props.rtlLayout} className="drp-user">
            ...
            <Dropdown.Menu alignRight className="profile-notification">
              <div className="pro-head">
                ...
                <span>John Doe</span>
                <div className="dud-logout" onClick={() => logout()}>
      ...
      <ChatList listOpen={listOpen} closed={() => {setList(false)}} />
    </Aux>
  );
}
